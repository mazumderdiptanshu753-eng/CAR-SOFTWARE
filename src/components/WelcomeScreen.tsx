      ...
      <div className="relative z-10 max-w-2xl w-full bg-[#081026]/90 backdrop-blur-2xl border-2 border-cyan-500/40 rounded-[32px] p-8 sm:p-12 shadow-[0_0_80px_rgba(6,182,212,0.25)] flex flex-col items-center text-center gap-6 animate-in fade-in zoom-in duration-500">
        ...
        <div className="flex flex-col gap-2">
          <div className="inline-flex items-center justify-center gap-2 px-3.5 py-1 rounded-full bg-cyan-500/10 border border-cyan-400/30 text-cyan-300 text-xs font-mono font-bold tracking-widest uppercase">
            ...
            <span>GPS-Denied Autonomous Navigation</span>
          </div>
        ...
        <div className="grid grid-cols-2 sm:grid-cols-3 gap-2.5 w-full max-w-md pt-2">
          {[
            ...
            <div key={idx} className="bg-slate-900/60 border border-indigo-500/20 px-3 py-2 rounded-xl text-[11px] font-bold text-slate-300 flex items-center justify-center gap-1.5 shadow-xs">
        ...
        <button
          onClick={handleStart}
          className="mt-4 px-8 py-4 rounded-2xl bg-gradient-to-r from-cyan-500 via-teal-500 to-indigo-600 hover:from-cyan-400 hover:to-indigo-500 text-slate-950 font-black text-base sm:text-lg shadow-[0_0_30px_rgba(6,182,212,0.5)] active:scale-95 transition-all cursor-pointer flex items-center gap-3"
        >
          <span>Start Mission Cockpit</span>
